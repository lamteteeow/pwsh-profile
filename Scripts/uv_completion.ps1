...
Register-ArgumentCompleter -Native -CommandName 'uv' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'uv;run' {
            ...
            [CompletionResult]::new('--no-group', '--no-group', [CompletionResultType]::ParameterName, 'Exclude dependencies from the specified dependency group')
            ...
            [CompletionResult]::new('--no-dev', '--no-dev', [CompletionResultType]::ParameterName, 'Omit the development dependency group')
        ...
        'uv;tool;install' {
            ...
            [CompletionResult]::new('--with-editable', '--with-editable', [CompletionResultType]::ParameterName, 'Include the given packages as editables')
